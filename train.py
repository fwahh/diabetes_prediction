...
X_train = df_train.applymap(lambda val: (0 if val in ('No', 'Negative', 'Male')
                                         else 1 if val in ('Yes', 'Positive', 'Female')
                                         else val))
X_test = df_test.applymap(lambda val: (0 if val in ('No', 'Negative', 'Male')
                                       else 1 if val in ('Yes', 'Positive', 'Female')
                                       else val))
